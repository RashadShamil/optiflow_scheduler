...
class _MachinesScreenState extends State<MachinesScreen> {
  ...
  Future<void> _save({Map<String, dynamic>? machine}) async {
    ...
    final price = TextEditingController(
      text: machine?['price_per_hour']?.toString() ?? '',
    );
    final image = TextEditingController(
      text: machine?['image_url']?.toString() ?? '',
    );
              ...
              children: [
                ...
                TextField(
                  ...
                  decoration: const InputDecoration(
                    labelText: 'External price per hour (Rs.)',
                  ),
                ),
                const SizedBox(height: 12),
                TextField(
          ...
          children: [
            const Column(
              ...
              children: [
                ...
                Text(
                  'Scheduler resources and external rental settings',
          ...
          (machine) => Card(
            ...
            child: ListTile(
              ...
              trailing: Wrap(
                children: [
                  IconButton(
                    onPressed: () => _save(machine: machine),
