...
class ApiService {
  ...
  Future<List<Map<String, dynamic>>> fetchResources({
    ...
    final uri = Uri.parse('$_api/resources').replace(queryParameters: query.isEmpty ? null : query);
    final response = await http.get(uri, headers: _headers);
    return List<Map<String, dynamic>>.from(_decode(response) as List);
  }

  Future<List<Map<String, dynamic>>> fetchMachines() => fetchResources(type: 'MACHINE');

  Future<List<Map<String, dynamic>>> fetchHumanResources({bool includeExternal = false}) =>
      fetchResources(type: 'HUMAN', includeExternal: includeExternal);

  Future<List<Map<String, dynamic>>> fetchBookableMachines() async {
    final response = await http.get(Uri.parse('$_api/machines/bookable'), headers: _headers);
    return List<Map<String, dynamic>>.from(_decode(response) as List);
  }
  ...
  Future<void> deleteResource(String id) async {
    final response = await http.delete(Uri.parse('$_api/resources/$id'), headers: _headers);
    _decode(response);
  }

  Future<List<Map<String, dynamic>>> fetchOperationTypes() async {
    final response = await http.get(Uri.parse('$_api/operation-types'), headers: _headers);
    return List<Map<String, dynamic>>.from(_decode(response) as List);
  }

  Future<List<Map<String, dynamic>>> fetchCapabilities() async {
    final response = await http.get(Uri.parse('$_api/capabilities'), headers: _headers);
    return List<Map<String, dynamic>>.from(_decode(response) as List);
  }
  ...
  Future<void> deleteCapability(String id) async {
    final response = await http.delete(Uri.parse('$_api/capabilities/$id'), headers: _headers);
    _decode(response);
  }
  ...
  Future<Map<String, dynamic>> optimizeJob(String jobId) async {
    final response = await http.post(Uri.parse('$_api/optimize/$jobId'), headers: _headers);
    return Map<String, dynamic>.from(_decode(response) as Map);
  }

  Future<void> dispatchTask(String taskId) async {
    final response = await http.post(Uri.parse('$_api/tasks/$taskId/dispatch'), headers: _headers);
    _decode(response);
  }

  Future<List<Map<String, dynamic>>> fetchMyTasks() async {
    final response = await http.get(Uri.parse('$_api/me/tasks'), headers: _headers);
    return List<Map<String, dynamic>>.from(_decode(response) as List);
  }
  ...
  Future<void> _taskAction(String taskId, String action) async {
    final response = await http.post(Uri.parse('$_api/tasks/$taskId/$action'), headers: _headers);
    _decode(response);
  }

  Future<Map<String, dynamic>> fetchSchedule() async {
    final response = await http.get(Uri.parse('$_api/schedule'), headers: _headers);
    return Map<String, dynamic>.from(_decode(response) as Map);
  }
  ...
  Future<Map<String, dynamic>> fetchMachineAvailability(String machineId, DateTime day) async {
    final date = '${day.year.toString().padLeft(4, '0')}-${day.month.toString().padLeft(2, '0')}-${day.day.toString().padLeft(2, '0')}';
    final uri = Uri.parse('$_api/machines/$machineId/availability').replace(queryParameters: {'day': date});
    final response = await http.get(uri, headers: _headers);
    return Map<String, dynamic>.from(_decode(response) as Map);
  }
  ...
  Future<List<Map<String, dynamic>>> fetchMyBookings() async {
    final response = await http.get(Uri.parse('$_api/machine-bookings/mine'), headers: _headers);
    return List<Map<String, dynamic>>.from(_decode(response) as List);
  }

  Future<List<Map<String, dynamic>>> fetchBookingRequests({String? status}) async {
    final uri = Uri.parse('$_api/machine-bookings').replace(
  ...
  Future<List<Map<String, dynamic>>> fetchOpenWorkOffers() async {
    final response = await http.get(Uri.parse('$_api/work-offers'), headers: _headers);
    return List<Map<String, dynamic>>.from(_decode(response) as List);
  }

  Future<List<Map<String, dynamic>>> fetchMyWorkOffers() async {
    final response = await http.get(Uri.parse('$_api/work-offers/mine'), headers: _headers);
    return List<Map<String, dynamic>>.from(_decode(response) as List);
  }

  Future<void> claimWorkOffer(String offerId) async {
    final response = await http.post(Uri.parse('$_api/work-offers/$offerId/claim'), headers: _headers);
    _decode(response);
  }

  Future<Map<String, dynamic>> fetchDashboardStats() async {
    final response = await http.get(Uri.parse('$_api/dashboard-stats'), headers: _headers);
    return Map<String, dynamic>.from(_decode(response) as Map);
  }
}
