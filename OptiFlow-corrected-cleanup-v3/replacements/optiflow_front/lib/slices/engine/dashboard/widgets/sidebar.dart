          ...
          Padding(
            ...
            child: Row(
              children: [
                ...
                const Text('OptiFlow', style: TextStyle(fontSize: 18, fontWeight: FontWeight.w800)),
              ],
            ),
          ),
          Expanded(
              ...
              itemBuilder: (_, index) {
                ...
                return Padding(
                  ...
                  child: ListTile(
                    ...
                    leading: Icon(item.$1, color: selected ? AppColors.primary : AppColors.textSecondary),
                    title: Text(
                      item.$2,
                      style: TextStyle(
