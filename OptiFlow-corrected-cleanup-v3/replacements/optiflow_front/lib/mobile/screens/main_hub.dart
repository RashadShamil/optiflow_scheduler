  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      bottomNavigationBar: NavigationBar(
        ...
        destinations: const [
          NavigationDestination(icon: Icon(Icons.task_alt_outlined), selectedIcon: Icon(Icons.task_alt), label: 'My Work'),
        ...
        child: _QrScanner(
          onMachineId: (machineId) {
            ...
            Navigator.of(context).push(
              MaterialPageRoute(builder: (_) => MachineBookingPage(machineId: machineId)),
            );
          },
        ),
      ),
...
class _ProfileScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(backgroundColor: AppColors.background, title: const Text('Profile')),
      body: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            Text(auth.displayName, textAlign: TextAlign.center, style: const TextStyle(fontSize: 22, fontWeight: FontWeight.w900)),
            const SizedBox(height: 4),
            Text(auth.role, textAlign: TextAlign.center, style: const TextStyle(color: AppColors.textSecondary)),
            const Spacer(),
            OutlinedButton.icon(
