...
class WorkOfferModel {
  ...
  factory WorkOfferModel.fromJson(Map<String, dynamic> json) {
    final task = json['tasks'] is Map ? Map<String, dynamic>.from(json['tasks'] as Map) : <String, dynamic>{};
    final job = task['jobs'] is Map ? Map<String, dynamic>.from(task['jobs'] as Map) : <String, dynamic>{};
